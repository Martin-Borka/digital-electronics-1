...
begin
    ...
    --------------------------------------------------------
    --nastavení všech ostatních dat
    p_stimulus : process
    begin
        report "Stimulus process started";
        s_data <='0'; wait for 2 ns;
        s_data <='1'; wait for 12 ns;
        s_data <='0'; wait for 33 ns;
        s_data <='1'; wait for 32 ns;
        s_data <='0'; wait for 33 ns;
        s_data <='1'; wait for 68 ns;
        s_data <='0'; wait for 66 ns;
        s_data <='1'; wait for 64 ns;
        s_data <='0'; wait for 60 ns;
